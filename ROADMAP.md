...
借鉴 Multica 的 8 条核心理念(行为与数据模型为主;Issue 看板/详情视觉层级见 [DESIGN.md](./DESIGN.md) §8.6,不引入 Project/Labels):
...
**状态(2026-07-18)**:阶段 0–6(v0.3–v0.9)均已落地。下一刀是 **v1.0.0 GA**:E2E 验收、毒化会话 resume、Skill 复利叙事打磨、发布打包与文档一致性。
