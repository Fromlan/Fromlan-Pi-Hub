...
**完全不做**:Multica 的 WebSocket 队列、跨 Workspace、多人协作、16 CLI 支持、Cloud Runtimes。Fromlan Pi Hub 是本地单机 + 单 CLI,这是定位决定的。
...
**状态(2026-07-19)**:阶段 0–6(v0.3–v0.9)与 **Projects / Squad 加深**(v0.9.x)均已落地。下一刀是 **v1.0.0 GA**:E2E 验收、毒化会话 resume、Skill 复利叙事打磨、发布打包与文档一致性。
...
| v1.0.0 | 整体 | — | GA：打磨、E2E 验收、文档与发布打包 |
...
**刻意未做**(与计划一致):
- workdir/session 毒化后的精细 resume 策略(Multica 级)
- Autopilot webhook
- 从成功 run 自动提炼 Skill
...
下次阶段:**v1.0.0**(打磨与正式 GA)。编排层 v0.5–v0.9 已于 2026-07-18 交付；Projects / Squad 加深见上方 v0.9.x 节。
