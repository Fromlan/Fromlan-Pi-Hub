...
借鉴 Multica 的核心理念(行为与数据模型为主;Issue 看板/详情视觉层级见 [DESIGN.md](./DESIGN.md) §8.6；已引入 **Project** 分组容器，仍不做 Labels):
...
**状态(2026-07-18)**:阶段 0–6(v0.3–v0.9)均已落地；另已补齐 **Projects**（Issue 分组 / 进度 / 可选 defaultCwd）。下一刀是 **v1.0.0 GA**:E2E 验收、毒化会话 resume、Skill 复利叙事打磨、发布打包与文档一致性。
...
| **v0.9.x** | **Projects** | **2026-07-18** | Project 容器 + projectId + 进度 + defaultCwd 派活 |
...
下次阶段:**v1.0.0**(打磨与正式 GA)。编排层 v0.5–v0.9 已于 2026-07-18 交付。
